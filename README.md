...
> This figure illustrates the overall workflow of our method, where MDD, NDS, MDS, and SDS stand for Minimal Disagreement Detector, No Disagreement Samples, Minor Disagreement Samples, and Severe Disagreement Samples, respectively. The four model blocks in the figure all refer to the same model.

## Main Results
<div align="center">
<img src="assets/main_result.png">
</div>
> We select three representative methods for comparison: majority voting (majority), Best of N with outcome reward model (BoN), and [SCoP](https://github.com/Yue-LLM-Pit/SCoP/).
